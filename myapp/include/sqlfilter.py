                ...
                if type in list_type:
                    ...
                    if type == 'create' or type == 'drop' or type == 'alter':
                        ...
                        # filter ddl for mysql.* table
                            ...
                            if mylist[2].lower() == 'table' \
                                    and mylist[3].lower().split('.')[0].lower() in ['mysql', '`mysql`']:
                                sqllist.pop(i)
                                continue
...
if __name__ == '__main__':
    x = " insert into item_infor(id,name) values(7,'t\\'e\"st'); drop /*sdf\n\n\n\n\n\fd*/  abase ;" \
        "#adfadfaf \n select adf; create;alter table mysql.user ; create /*\\'\" test */ " \
        "table test (id int ,name varchar(30)) comment 'asdasdasd';" \
        "\n;/*! test &&\''& */\r\n;\r\n/*!40101 SET character_set_client = @saved_cs_client */;" \
        "alter  user asdf sdf;\r;create table test ;\n;;;select /* force index test \'\"*/ * from test ;"
    # print x
